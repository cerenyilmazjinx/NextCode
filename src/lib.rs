...
#[derive(Debug)]
pub struct NextCodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextCodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextCode processing");
    
    let mut processor = NextCodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextCodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextCodeProcessor::new(false);
